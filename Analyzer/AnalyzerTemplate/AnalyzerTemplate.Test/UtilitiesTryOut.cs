...
namespace AnalyzerTemplate.Test{
    ...
    public class UtilitiesTryOut
    {
        ...
        public static async Task<(ImmutableArray<Diagnostic> diagnostics, Document document, Workspace workspace)>
